...
class NewListViewUnitTest(unittest.TestCase):
    ...
    def test_passes_POST_data_to_NewListForm(self, mockNewListForm):    # pylint: disable=invalid-name
        new_list(self.request)
        mockNewListForm.assert_called_once_with(data=self.request.POST)

    def test_saves_form_with_owner_if_form_valid(self, mockNewListForm):    # pylint: disable=invalid-name
    ...
    def test_renders_home_template_with_form_if_form_invalid(self, mock_render, mockNewListForm):   # pylint: disable=invalid-name
        mock_form = mockNewListForm.return_value
...
class ShareListTest(TestCase):
    ...
    def test_redirect_after_post(self):
        ...
        list_ = List.objects.create()
        response = self.client.post(f'/lists/{list_.id}/share', {'sharee': 'share.with@me.com'})
